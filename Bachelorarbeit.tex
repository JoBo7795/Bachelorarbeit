...
\subsection{Regeln und Grenzwerte}

\begin{figure}[htbp]
  \includegraphics[scale=1,width=.5\textwidth]{img/CPUAnomalie/RollingRestart.PNG}
  \includegraphics[scale=1,width=.5\textwidth,height=.14\textheight]{img/CPUAnomalie/Saturation.PNG}
  \includegraphics[scale=1,width=.5\textwidth]{img/CPUAnomalie/Utilization.PNG}
\end{figure}

\begin{figure}[htbp]
  \includegraphics[scale=1,width=.6\textwidth]{img/CPUSkalierung/ReplicaCount.PNG}
  \includegraphics[scale=1,width=.6\textwidth,height=.124\textheight]{img/CPUSkalierung/NetzwerkUtilization.PNG}
  \includegraphics[scale=1,width=.6\textwidth]{img/CPUSkalierung/CPUUtilization.PNG}
\end{figure}
