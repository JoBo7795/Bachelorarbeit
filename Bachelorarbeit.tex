...
Die Grenzwerte bilden 

\begin{figure}[htbp]
  \includegraphics{Hysterese.png}
  \caption{Hysteresegraf der Grenzwerte(eigene Grafik)}
\end{figure}
...
\begin{minipage}{\linewidth}
            ...
            \captionof{figure}{Abbildungen Testwerte Testfall 1 (eigene Grafiken)} 
\end{minipage}
...
\begin{minipage}{\linewidth}
            ...
            \captionof{figure}{Abbildungen Testwerte Testfall 2 (eigene Grafiken)}
\end{minipage}
...
\begin{minipage}{\linewidth}
            ...
            \captionof{figure}{Abbildungen Testwerte Testfall 3 (eigene Grafiken)}
\end{minipage}
...
\begin{minipage}{\linewidth}
            ...
            \captionof{figure}{Abbildungen Testwerte Testfall 4 (eigene Grafiken)}
\end{minipage}
...
\begin{minipage}{\linewidth}
            ...
            \captionof{figure}{Abbildungen Testwerte Testfall 5 (eigene Grafiken)}
\end{minipage}
...
\begin{minipage}{\linewidth}
            ...
            \captionof{figure}{Abbildungen Testwerte Testfall 6 (eigene Grafiken)}
\end{minipage}
...
\begin{minipage}{\linewidth}
            ...
            \captionof{figure}{Abbildungen Testwerte Testfall 7 (eigene Grafiken)}
\end{minipage}
