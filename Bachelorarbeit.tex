...
\begin{minipage}{\linewidth}
  \includegraphics[scale=.3]{img/Datenaggregation/GrafAggregationNew.png}
    \captionof{figure}{Bildrepräsentation der Zeitreihe}
\end{minipage} \\
...
\begin{minipage}{\linewidth}
  \includegraphics[scale=.3]{img/Datenaggregation/GrafZeitNew.png} 
    \captionof{figure}{Bildrepräsentation der Zeitreihe als Graf}
\end{minipage} \\
...
\begin{minipage}{\linewidth}
  \includegraphics[scale=.3]{img/Datenaggregation/GrafYWertNew.png} 
    \captionof{figure}{Bildrepräsentation des Graf mit Y-Achsen Grenzwert}
\end{minipage}\\
...
\begin{minipage}{\linewidth}
  \includegraphics[scale=.3]{img/Datenaggregation/GrafAlarmNew.png} 
    \captionof{figure}{Bildrepräsentation der das Graf mit überschrittenem X-Achsen Grenzwert}
\end{minipage}\\
