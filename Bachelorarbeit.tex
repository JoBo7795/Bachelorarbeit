...
\begin{minipage}{\linewidth}
  \includegraphics[scale=.3]{img/Datenaggregation/LupeNew.png} 
    \captionof{figure}{Bildrepräsentation der Aggregation(Quelle Draw.io)}
\end{minipage} \\
...
\begin{minipage}{\linewidth}
  \includegraphics[scale=.3]{img/Datenaggregation/GrafAggregationNew.png}
    \captionof{figure}{Bildrepräsentation der Zeitreihe(eigene Grafik)}
\end{minipage} \\
...
\begin{minipage}{\linewidth}
  \includegraphics[scale=.3]{img/Datenaggregation/GrafZeitNew.png} 
    \captionof{figure}{Bildrepräsentation der Zeitreihe als Graf(eigene Grafik)}
\end{minipage} \\
...
\begin{minipage}{\linewidth}
  \includegraphics[scale=.3]{img/Datenaggregation/GrafYWertNew.png} 
    \captionof{figure}{Bildrepräsentation des Graf mit Y-Achsen Grenzwert(eigene Grafik)}
\end{minipage}\\
...
\begin{minipage}{\linewidth}
  \includegraphics[scale=.3]{img/Datenaggregation/GrafAlarmNew.png} 
    \captionof{figure}{Bildrepräsentation der das Graf mit überschrittenem X-Achsen Grenzwert(eigene Grafik)}
\end{minipage}\\
...
\begin{minipage}{\linewidth}
  \includegraphics[scale=.3]{img/Datenaggregation/AlarmNew.png}  
    \captionof{figure}{Bildrepräsentation des Alarms(Quelle Draw.io)}
\end{minipage} \\
...
\begin{minipage}{\linewidth}
  ...
  \captionof{figure}{Graf des Ablaufs der Datenaggregation(eigene Grafik)}
\end{minipage}
