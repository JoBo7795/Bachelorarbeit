...
\begin{minipage}{\linewidth}
            \includegraphics[width=.5\textwidth]{img/CPUAnomalie/RollingRestart.PNG}
...
\begin{minipage}{\linewidth}
            ...
            \includegraphics[scale=1,width=.5\textwidth,height=.14\textheight]{img/RAMAnomalie/RAMSaturation.PNG}
  			...
  			\includegraphics[scale=1,width=.5\textwidth]{img/RAMAnomalie/CPUUtilization.PNG}
  			\includegraphics[scale=1,width=.5\textwidth]{img/RAMAnomalie/Netzwerk.PNG}
            \captionof{figure}{Transfer from R1 to R2 whenK1=1}
\end{minipage}
